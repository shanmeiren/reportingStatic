...
HarPreview.prototype =
{
    initialize: function(content)
    {
        ...
        var that=this;
        var harFile = Lib.getURLParameter('har',content.baseURI);
        var nm=harFile.substr(harFile.lastIndexOf('/')+1);
        
        var jsonString =require(['./newui/'+nm],function(data){
            that.appendPreview(data)  
        });
